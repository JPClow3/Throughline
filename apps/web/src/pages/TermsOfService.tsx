  ...
  return (
    <div className="landing-layout">
      ...
      <main className="landing-main" style={{ padding: "4rem 1.5rem", maxWidth: "800px", margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "var(--text-display-lg)", marginBottom: "2rem" }}>Termos de Serviço</h1>
        
        <div className="surface" style={{ padding: "2rem", display: "grid", gap: "1.5rem", fontSize: "1.05rem", lineHeight: "1.6" }}>
          <section>
            <h2 style={{ fontSize: "1.4rem", marginBottom: "0.5rem" }}>1. Aceitação dos Termos</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: "1.4rem", marginBottom: "0.5rem" }}>2. Uso do Aplicativo</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: "1.4rem", marginBottom: "0.5rem" }}>3. Conta e Segurança</h2>
            <p>
          ...
          <section>
            <h2 style={{ fontSize: "1.4rem", marginBottom: "0.5rem" }}>4. Modificações no Serviço</h2>
            <p>
