# Reviewer M5-1 Context: Final Project Code & Test Suite Review
...
3. Verify compliance with Inkline design guidelines and AGENTS.md product/engineering rules.
4. Deliver verdict: APPROVE or REQUEST_CHANGES in `H:\Code\Pessoais\Throughline\.agents\reviewer_m5_1\handoff.md`.
